                ...
                if (isset($row['isAdmin']) && $row['isAdmin'] == 1) {
                    ...
                    if (count($childrenResult) > 0) {
                        ...
                        foreach ($childrenResult as $kidRow) {
                            ...
                            echo '<div class="card' . $genderClass . ' mx-2 mb-4" style="flex: 0 0 auto; width: 200px; min-height: 350px; text-align: center;">'; // Adjust the width and min-height as needed
...
<head>
    ...
    transition: background-image 0.5s ease, background-size 0.5s ease, background-position 0.5s ease, box-shadow 0.5s ease, transform 0.5s ease; /* Add transform transition */
    animation: slideUp 1s ease-in-out; /* Apply the slide-up animation */
}
...
@keyframes slideUp {
    ...
    transform: translateY(20px); /* Move the text down slightly */
...
.card-img-top:hover {
    transform: scale(1.1);
    /* Add any additional hover effects you'd like */
}
...
.custom-radio .card-male label:hover img {
    ...
    position: absolute;
    top: 30px;
    left: 48%; /* Center the logo horizontally */
    right: 50%;
    transform: translateX(-50%);
    width: 350px; /* Adjust the initial width as needed */
    transform-origin: center bottom;
    transition: transform 0.3s ease-in-out, opacity 0.3s ease-in-out; /* Add smooth transition for the animation */
}


.logo:hover {
    transform: translateX(-50%) scale(1.2); /* Scale and slightly move up on hover */
